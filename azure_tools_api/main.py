...
app = FastAPI(
    ...
    version="1.0.0",
    description=(
        "Standalone tools API for Azure integration. "
        "It exposes seller operations as authenticated tool endpoints."
    ),
)
    ...
    <html lang="en">
      ...
      <body>
        <main>
          ...
          <p>This standalone API is meant for Azure tool integration and Render deployment.</p>
          <div class="card">
            <h2>Useful links</h2>
            <ul>
